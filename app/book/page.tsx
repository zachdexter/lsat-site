              ...
              <div className="absolute inset-0 flex items-center justify-center rounded-xl border-2 border-indigo-200 dark:border-slate-700 bg-white dark:bg-slate-800 z-20">
                <div className="text-center p-6 max-w-md">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                    Please refresh the page to try again, or visit{' '}
                    <a
                      href={CALENDLY_URL}
                      target="_blank"
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 bg-white dark:bg-slate-700 border-2 border-indigo-600 dark:border-indigo-400 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-slate-600 rounded-lg font-medium transition-colors inline-flex items-center justify-center"
                    >
                      Visit Calendly
                    </a>
                  </div>
