    ...
    <div className="space-y-20">
      ...
      <FadeIn>
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">Three simple steps to get started</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <FadeIn delayMs={0} className="flex flex-col">
              <div className="group relative flex flex-1 flex-col rounded-2xl border-2 border-indigo-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-indigo-200 hover:shadow-lg">
