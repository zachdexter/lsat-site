  ...
  return (
    <div className="py-12 text-center">
      ...
      {actionLabel && actionHref && (
        <Link
          href={actionHref}
          className="inline-block rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-all hover:bg-indigo-700 hover:shadow-md hover:scale-[1.02] active:scale-95"
          onMouseEnter={(e) => {
