  ...
  useEffect(() => {
    async function loadUser() {
      ...
      if (user) {
        ...
        if (profileError) {
          console.error('Error loading profile in NavBar:', profileError);
        }
  ...
  return (
    <>
      <header className="sticky top-0 z-30 border-b border-indigo-100 bg-white/80 backdrop-blur-sm shadow-sm">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6 md:pl-72">
